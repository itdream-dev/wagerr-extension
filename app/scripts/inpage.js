...
var metamaskStream = new LocalMessageDuplexStream({
  name: 'wagerrwallet_inpage',
  target: 'wagerrwallet_contentscript',
})
...
// window.wagerrWallet = inpageProvider
...
if (typeof window.web4bch !== 'undefined') {
  throw new Error(`Wagerr detected another web4bch.
     Wagerr will not work reliably with another web4bch extension.
     This usually happens if you have two MetaMasks installed,
     or Wagerr and another web4bch extension. Please remove one
     and try again.`)
}
var web4bch = new Web4Bch(inpageProvider)
web4bch.setProvider = function () {
  // log.debug('Wagerr - overrode web4bch.setProvider')
}
// log.debug('Wagerr - injected web4bch')
...
function cleanContextForImports () {
  ...
  try {
    ...
    console.warn('Wagerr - global.define could not be deleted.')
  }
}
...
function restoreContextAfterImports () {
  try {
    ...
    console.warn('Wagerr - global.define could not be overwritten.')
  }
}
