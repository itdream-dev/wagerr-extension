      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            />
            <div className="buy-ether__body-text">
              Deposit WAGERR directly into your account.
            </div>
            <div className="buy-ether__small-body-text">
              (This is the account address that Wagerr created for you to
              recieve funds.)
            </div>
            <div className="buy-ether__buttons">
              <button
  ...
  render () {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__title">Deposit WAGERR</div>
        <div className="buy-ether__body-text">
          Wagerr works best if you have WAGERR in your account to pay for
          transaction fees and more. To get WAGERR, choose from one of these
          methods.
        </div>
