...
class BackupPhraseScreen extends Component {
  ...
  exportSeedWords = () => {
    ...
    exportAsFile('Wagerr Secret Backup Phrase', seedWords, 'text/plain')
  }
    ...
    return (
      <div className="backup-phrase__content-wrapper">
        <div className="backup-phrase__phrase">
          ...
          <div className="backup-phrase__body-text">
            WARNING: Never disclose your backup phrase. Anyone with this phrase can take your WAGERR forever.
          </div>
