...
const BIG_NUMBER_WGR_MULTIPLIER = new BigNumber('1')
...
const toNormalizedDenomination = {
  ...
  WGR: bigNumber => bigNumber.div(BIG_NUMBER_WGR_MULTIPLIER),
}
const toSpecifiedDenomination = {
  ...
  WGR: bigNumber => bigNumber.times(BIG_NUMBER_WGR_MULTIPLIER).round(8),
}
const baseChange = {
  hex: n => n.toString(16),
