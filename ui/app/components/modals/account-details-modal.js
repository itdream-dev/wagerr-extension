...
AccountDetailsModal.prototype.render = function () {
  ...
  return (
    <AccountModalContainer>
      ...
      <QrView
        Qr={{
          data: address//showSLP ? slpAddress : address,
        }}
      />
      {/* <div
      ...
      >
        ...
        >
          {!showSLP ? 'View SLP Details' : 'View WGR Details'}
        </button>
      </div> */}
      ...
      <Button
        ...
        onClick={() =>
          global.platform.openWindow({
            url: genAccountLink(address, 1), //genAccountLink(showSLP ? slpAddress : address, 1),
          })
        }
      >
