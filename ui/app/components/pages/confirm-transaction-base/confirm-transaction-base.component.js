    ...
    return (
      <div className="page-container">
        ...
        <div className="confirm-page-container-summary">
          ...
          <br />
          <small>
            A tiny amount of WGR will be spent to cover the mining fee if you
            continue.
          </small>
        </div>
  ...
  renderFeeError = () => {
    ...
    return (
      <div className="page-container">
        ...
        <div className="confirm-page-container-summary">
          <p>
            Tokens require WAGERR (WGR) to pay the transaction fee, and
            your balance does not cover this.
          </p>
          <br />
          <br />
          <small>please acquire some WGR and try again.</small>
        </div>
