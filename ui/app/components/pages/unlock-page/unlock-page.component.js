...
export default class UnlockPage extends Component {
  ...
  async componentDidMount() {
    ...
    console.log('unlock page - componentDidMount ended')
  }
  ...
  async handleSubmit(event) {
    ...
    console.log('unlock page handleSubmit', password);
    try {
      await tryUnlockMetamask(password)
      this.submitting = false
      console.log('unlock page handleSubmit go to default route');
      history.push(DEFAULT_ROUTE)
    } catch ({ message }) {
      console.log('unlock page handleSubmit error', message);
